...
Description: Main GUI aplication
 */
package nievasj;
...
/**
 * Main GUI application that instances the classes and also all the graphic
 * objects
 *
...
//****************************************************************************** Structure
    ...
    /**
     * this is the method when any node is click on the gui
     *
     * @param e an actionEvent object that is used to get the soruce of the
     * event
     */
...
//*************************************************************************
    /**
     * this is the method that is called that calls that deck and set the bets
     * to the players
     */
    ...
    private void displayTable() {
        txaAreaCroupier.setText(croupierDeck.toString() + "         Total: " + croupierDeck.getCardsValue());
        txaAreaPlayer.setText(playerDeck.toString() + "         Total: " + (playerDeck.getCardsValue()));
        refreshFields();
    }

    /**
     * this is the method the refresh the field in the gui
     */
    ...
    /**
     * this method double the bet set by the user
     */
    ...
    /**
     * this method check s for the win in the game
     */
...
//****************************************************************************** Actions 
    /**
     * this method check s for the win in the game and save the record
     */
    ...
    /**
     * this method check s for the win in the game and save the game
     */
    ...
    /**
     * this method check s for the black jack win in the game and save it to the
     * file
     */
    ...
    /**
     * this is the method that get the bet of a specifc users
     *
    ...
    /**
     * this is the method that sets the css style if an error user makes
     *
    ...
    /**
     * this method reads everything on file and lod the deck
     */
...
/**
 * this is the method that plays music in the bacckground of the gui
